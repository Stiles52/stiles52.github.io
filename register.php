...
<head>
    ...
    <title>INSCRIPTION - ORIGIN</title>
...
<body class="bg-black min-h-screen relative">
    ...
    <section style="width:100%;height:calc(100vh - 53px);display:flex;align-items:center;justify-content:center;color:#fff;z-index:50;position:absolute;">
        <div class="auth-wrapper">
            <form id="register-form" method="POST" action="assets/handlers/auth-register">
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf, ENT_QUOTES) ?>">

                <div class="auth-card" style="padding:15px;border:1px solid #20d3ee33;">
                    <h3 class="font-bold text-white uppercase">Inscription <span class="text-cyan-400">au support</span></h3>
                    <div style="display:flex;justify-content:center;flex-direction:column;align-items:center;padding-top:45px;">
                        ...
                        <div style="width:100%;display:flex;justify-content:center;flex-direction:column;align-items:center;padding-bottom:25px;">
                            ...
                            <input type="text" name="pseudo" placeholder="Identifiant" autocomplete="username" required>
                        </div>
                        ...
                        <div style="width:100%;display:flex;justify-content:center;flex-direction:column;align-items:center;padding-bottom:25px;">
                            ...
                            <input type="password" name="password" placeholder="Min. 8 caractères" autocomplete="new-password" required>
                        </div>
                        ...
                        <div style="width:100%;display:flex;justify-content:center;flex-direction:column;align-items:center;padding-bottom:25px;">
                            ...
                            <input type="password" name="password2" placeholder="Confirmer" autocomplete="new-password" required>
                        </div>
                        ...
                        <p style="text-align:center;padding-top:15px;">Déjà un compte ? <a href="./login">Connectez-vous !</a></p>
                    </div>
                </div>
            </form>
            ...
            <div class="auth-actions" style="display:flex;justify-content:space-between;margin-top:15px;">
                ...
                <button type="submit" form="register-form" class="origin-btn btn--graphic btn--primary" data-sound-attached="true" style="font-size:16px;">
            ...
            <div style="display:flex;justify-content:flex-start;margin-top:60px;flex-direction:column;gap:15px;align-items:stretch;">
                <h6 style="text-align:center;">Ou inscrivez-vous par :</h6>
